...
const PopularDestinationCarousel=()=>{
  ...
  <div class="carousel-inner my-4">
    ...
    <div className="col-sm-4  position-relative">
        <img src={PlaceDetails[0].image} className="img-fluid rounded-3"/>
        <div className="badge badge-primary border bg-light text-dark position-absolute start-0 m-1" style={{width:"35%"}}>Rounded Trip Economy</div>
        <div className="row  text-white fw-bolder position-absolute bottom-0 w-100 ms-0 me-0">
          <div className="col fs-3 mt-4 shadow-md">{PlaceDetails[0].cityName}</div>
        ...
        <div className="col-sm-4  position-relative">
        <img src={PlaceDetails[1].image} className="img-fluid rounded-3"/>
        <div className="badge badge-primary border bg-light text-dark position-absolute start-0 m-1" style={{width:"35%"}}>Rounded Trip Economy</div>
        <div className="row  text-white fw-bolder position-absolute bottom-0 w-100 ms-0 me-0">
          <div className="col fs-3 mt-4 shadow-md">{PlaceDetails[1].cityName}</div>
          <div className="col"></div>
          <div className="col fs-4 mb-0 me-0" style={{textIndent:"40px"}}>
               Form 
               Rs:25000
    ...
    <div class="carousel-item">
    <div className="col-sm-4  position-relative">
        <img src={PlaceDetails[2].image} className="img-fluid rounded-3"/>
        <div className="badge badge-primary border bg-light text-dark position-absolute start-0 m-1" style={{width:"35%"}}>Rounded Trip Economy</div>
        <div className="row  text-white fw-bolder position-absolute bottom-0 w-100 ms-0 me-0">
          <div className="col fs-3 mt-4 shadow-md">{PlaceDetails[2].cityName}</div>
          <div className="col"></div>
          <div className="col fs-4 mb-0 me-0" style={{textIndent:"40px"}}>
               Form 
               Rs:25000
...
return (
   ...
   <div className="container">
    ...
    {/* main */}
    <div className={bussinessBannerStyles} style={{boxShadow:"7px 10px  rgba(0, 0, 0, 0.26)"}}>
     <div className="col-sm-4">
      <div className="row">
      <h2 className="text-center mb-4">Your OneStep Solution
        For booking business, 
        travel quickly,simply
        and efficient
      </h2>
        <div className="row">
          <div className="col"></div>
        <button className={getStartedButtonStyles} style={{background:"#70ef2d"}}>Get Strarted</button>
        <div className="col"></div>
        </div>
      </div>
     </div>
     ...
     <div className="col-sm-4">
      <img className="img-fluid mt-4 rounded-4" src={person1} alt="bussinessperson"/>
      </div>
    </div>
   </div>
   </>
...
<div id="carouselExampleControls" className="carousel" data-bs-touch="true">
  <div className="carousel-inner">
    ...
    <div className="row">
      <div className={commonStylesForCarouselItem} style={{width:commonWidth}}>
          <FontAwesomeIcon icon={faHeadset} className={commonStyleForIcon} />
          <h3 className="text-primary-emphasis fw-bolder">Customer Support</h3>
          <h5>24/7 Customer Support</h5>
          </div>

          <div className={commonStylesForCarouselItem} style={{width:commonWidth}}>
          <FontAwesomeIcon icon={faAward} className={commonStyleForIcon} />
          <h3 className="text-primary-emphasis fw-bolder">Air Point Rewards</h3>
          <h5>Loyalty Reward Program</h5>
          </div>

          <div className={commonStylesForCarouselItem} style={{width:commonWidth}}>
          <FontAwesomeIcon icon={faMoneyBillTransfer} className={commonStyleForIcon} />
...
<div className="carousel-item active">
    <div className="row">
      <div className={commonStylesForCarouselItem} style={{width:commonWidth}}>
          <FontAwesomeIcon icon={faPlaneDeparture} className={commonStyleForIcon} />
          ...
          <div className={commonStylesForCarouselItem} style={{width:commonWidth}}>
          <FontAwesomeIcon icon={faFaceSmileWink} className={commonStyleForIcon} />
