...
let commonStyleForIcon = `fs-1 p-3`;
 ...
 export let AdvertiseBanner=styled.div `
    background-image:linear-gradient(rgba(137, 133, 133, 0.5), rgba(170, 165, 165, 0.5)), url(${china});
...
`
  ...
  const FinalBanner=()=>{
    return (
      ...
      <h1 className={commonStylesForSubHeading}>BOOK CHEAP FLIGHTS ON YOUR FAVOURITE AIRLINES</h1>
      </div>
      </div>
      </div>
    ...
    const Stories=()=>{
      ...
      return (
        <>
        <div className="container-fluid mt-4" style={{backgroundColor:"rgb(240, 242, 166)"}}>
         <h1 className={specialStyle}>Stories</h1>
      </div>
       <div className="container">
      <p className="text-secondary fw-bold fs-1 mb-5 text-center">Your Next Adventure Starts Here!"-
...
return (
  <>
   <div className="container-fluid mt-5 pt-2 pb-4" style={{backgroundColor:'#F0F2A6'}}>
...
const Service=({item1,serviceFlag})=>{
  ...
  <>
    ...
    <div className="card-body">
     ...
     <div className="card" style={{boxShadow:"5px 2px 0px 1px rgba(0, 0, 0, 0.14)"}}>
     <img src={item1.image} alt="" className="card-img-top rounded-3" />
     <div className="card-body">
      ...
      <div className="container my-5">
        <div className="row ">
          <div className="col-12 position-relative"> 
            ...
            <div className="row h-50 d-flex fw-bolder text-wrap  mt-0 ms-0 me-0" style={{position:"absolute",top:"26%"}}>
              <div className="col-5 align-self-end">
              <p className="fs-3" style={{color:"#00F2F2",textShadow:"2px 2px 4px white,2px 2px 4px #FF84E8"}}>4 Days & 3 Nights</p>
              </div>
              <div className="col-5 align-self-start">
              <p className="fs-3" style={{color:"red",textShadow:"3px 3px 5px white,2px 2px 4px rgb(0, 204, 255)"}}>Accomdation & Food</p>
              </div>
            </div>
            <div className="row text-white fw-bolder position-absolute bottom-0 w-100 ms-0 me-0">
              ...
              <div className="col-2"></div>
              <div className="col fs-4 mb-0 me-0 " style={{ textIndent: "40px" }}>
                <span className="text-info">From </span>Rs:20000<del className="row text-danger">25000</del>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              ...
              <div className="row">
                ...
                <button
                  ...
                  style={{ background: "#70ef2d" } } onClick={navigateToBusinessPage}
                >
                  Get Strarted
                </button>
                <div className="col"></div>
    ...
    <>
      ...
      <AdvertiseBanner className="d-flex align-items-end">
          <div className="container  text-center">
            <div className="row">
              <div className="col">
                  <p className="text-white fs-1">Discover Your Next Great Adventure</p>
